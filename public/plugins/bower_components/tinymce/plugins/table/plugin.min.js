        ...
        return function(g, h) {
            ...
            function r(a, b, c, d) {
                ...
                for (e = G[b][a].elm.parentNode, g = 1; c >= g; g++)
                    if (e = M.getNext(e, "tr")) {
                        ...
                        if (-1 == f)
                            for (h = 1; d >= h; h++) e.insertBefore(p(e.cells[0]), e.cells[0])
                    }
            }
            ...
            function t(b, c, d) {
                ...
                if (b ? (f = B(b), g = f.x, h = f.y, j = g + (c - 1), n = h + (d - 1)) : (I = J = null, e(G, function(a, b) {
                    ...
                    for (s(), i(), r = k(g, h).elm, l(r, "colSpan", j - g + 1), l(r, "rowSpan", n - h + 1), p = h; n >= p; p++)
                        for (o = g; j >= o; o++) G[p] && G[p][o] && (b = G[p][o].elm, b != r && (u = a.grep(b.childNodes), e(u, function(a) {
                            r.appendChild(a)
            ...
            function E(a) {
                ...
                if (J = B(a), I && J) {
                    ...
                    for (k = c; e >= k; k++)
                        for (j = b; d >= j; j++) a = G[k][j], a.real && (h = a.colspan - 1, i = a.rowspan - 1, h && j + h > f && (f = j + h), i && k + i > g && (g = k + i));
                    for (M.removeClass(M.select("td.mce-item-selected,th.mce-item-selected"), "mce-item-selected"), k = c; g >= k; k++)
                        for (j = b; f >= j; j++) G[k][j] && M.addClass(G[k][j].elm, "mce-item-selected")
                }
            }
        ...
        return function(g) {
            ...
            function j() {
                g.on("KeyDown SetContent VisualAid", function() {
                    ...
                    a && "TABLE" == a.nodeName && (g.settings.forced_root_block ? g.dom.add(g.getBody(), g.settings.forced_root_block, g.settings.forced_root_block_attrs, b.ie && b.ie < 11 ? "&nbsp;" : '<br data-mce-bogus="1" />') : g.dom.add(g.getBody(), "br", {
                        "data-mce-bogus": "1"
                    }))
