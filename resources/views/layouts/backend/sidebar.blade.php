<div class="navbar-default sidebar" role="navigation">
    <div class="sidebar-nav navbar-collapse slimscrollsidebar">
        <ul class="nav" id="side-menu">
            ...
            <li><a href="dashboard.html" class="waves-effect"><i class="linea-icon linea-basic fa-fw" data-icon="v"></i>
            ...
            <li><a href="settings.html" class="waves-effect"><i class="icon-settings"></i>
